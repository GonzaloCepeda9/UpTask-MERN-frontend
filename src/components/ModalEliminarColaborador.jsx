            ...
            <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
              ...
              <div className="sm:flex sm:items-start">
                ...
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                  <Dialog.Title as="h3" className="text-md leading-6 font-bold text-gray-900 max-[640px]:text-xs">
                    Eliminar Colaborador
                  </Dialog.Title>
                  <div className="text-sm mt-2 text-gray-500 max-[640px]:text-xs">
                    Una vez eliminada, la persona no podrá acceder al proyecto. ¿Desea eliminarla?
                  </div>
                </div>
              </div>
